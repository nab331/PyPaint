...
brush = MyButton(os.path.join("Resources","brush.png") , 25  , 33 , 100 , 120  , 'Brush' , [ '*PAINT COLOURS*' , ' ' , 'Current Size : '] , coolred )
pencil = MyButton(os.path.join("Resources","color_pencil.png") , 130  , 39 , 100 , 120  , 'Pencil' , [ '*DRAW*' , ' ' ,  'Current Size : '] , carrot )
eraser = MyButton(os.path.join("Resources","eraser.png"), 30  , 176 , 100 , 120  , 'Eraser' , [ '*CLEARS SELECTED*' , ' ' ,  'Current Size : '] , coolblue )
rbin = MyButton(os.path.join("Resources","bin.png"), 135  , 176 , 100 , 120  , 'Clear' , [ '*CLEARS ALL*' , ' ' ,  'Current Size : '] , cloud )
#colour = MyButton('Resources/colour.png' , 82  , 320 , 100 , 120  , 'Colour' , [ '*CLEARS ALL*' , ' ' ,  'Current Size : '] , cloud )

bplus = MyButton(os.path.join("Resources","plus.png") , 31  , 510 , 35 , 45 , 'Brush Size +' , [ '**INCREASE SIZE**' , 'Current Size : '] , coolred )
bminus = MyButton(os.path.join("Resources","minus.png"), 200  , 510 , 35 , 50 , 'Brush Size -' , [ '**DECREASE SIZE**' , 'Current Size : '] , coolblue )

cplus = MyButton(os.path.join("Resources","plus.png"), 31  , 450 , 35 , 45 , 'Darken Brush' , [ '**INCREASE SIZE**' , 'Current Size : '] , coolred )
cminus = MyButton(os.path.join("Resources","minus.png"), 200  , 450 , 35 , 50 , 'Lighten Brush' , [ '**DECREASE SIZE**' , 'Current Size : '] , coolblue )
